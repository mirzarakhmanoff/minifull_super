(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_b7b38d._.js", {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Layout.useEffect": ()=>{
            ...
            if (!token) {
                ...
                const verifyUser = {
                    "Layout.useEffect.verifyUser": async ()=>{
                        try {
                            const token = localStorage.getItem("token");
                            if (!token) {
                                throw new Error("Token not found");
                            }
                            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("http://localhost:8080/api/users/me", {
                                headers: {
                            ...
                            try {
                                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("http://localhost:8080/api/users/admin/me", {
                                    headers: {
                                        Authorization: `Bearer ${token}`
                                    }
                                });
...
_s(Layout, "Y90Il5O5SQ2rPZEKFwcAbNK84wM=", false, function() {
    return [
...
//# sourceMappingURL=_b7b38d._.js.map