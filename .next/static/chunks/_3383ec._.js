(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_3383ec._.js", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/axios/lib/axios.js [app-client] (ecmascript)"); // Импортируем axios для работы с запросами
...
function DataTable() {
    ...
    const fetchUsers = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/api/users");
    ...
    const handleSaveChanges = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/api/users/${editedUser.id}`, editedUser); // Отправка запроса на обновление
    ...
    const handleDelete = async (id)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/api/users/${id}`); // Отправка запроса на удаление
            fetchUsers(); // Обновляем список пользователей
        } catch (error) {
...
//# sourceMappingURL=_3383ec._.js.map