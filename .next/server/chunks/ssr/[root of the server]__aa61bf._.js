        ...
        if (!token) {
            ...
            const verifyUser = async ()=>{
                try {
                    ...
                    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("http://localhost:8080/api/users/me", {
                        headers: {
                    ...
                    try {
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("http://localhost:8080/api/users/admin/me", {
                            headers: {
                                Authorization: `Bearer ${token}`
                            }
                        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__aa61bf._.js.map