...
"[project]/app/(root)/user/components/Table/Table.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Degreetable = ()=>{
    ...
    const filteredData = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dataa"].filter((item)=>item.fullName.toLowerCase().includes(searchTerm.toLowerCase()) || item.title.toLowerCase().includes(searchTerm.toLowerCase()) || item.personalPartners.toLowerCase().includes(searchTerm.toLowerCase()) || item.activeRange.toLowerCase().includes(searchTerm.toLowerCase()) || item.lowNumberOfNetworkUsers.toString().includes(searchTerm) || item.bonusAmount.toString().includes(searchTerm));
...
"[project]/app/(root)/user/(root)/degree/page.jsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=_0b5535._.js.map