...
"[project]/app/(root)/user/components/PeopleTable/PeopleTable.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const PeopleTable = ()=>{
    ...
    const filteredData = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockData"].filter((person)=>person.fullName.toLowerCase().includes(searchTerm.toLowerCase()) || person.userId.toLowerCase().includes(searchTerm.toLowerCase()) || person.title.toLowerCase().includes(searchTerm.toLowerCase()) || person.status.toLowerCase().includes(searchTerm.toLowerCase()) || person.registerDate.toLowerCase().includes(searchTerm.toLowerCase()) || person.paymentTime.toLowerCase().includes(searchTerm.toLowerCase()));
...
"[project]/app/(root)/user/(root)/my-people/page.jsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=_83a799._.js.map