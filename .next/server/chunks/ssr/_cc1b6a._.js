...
(()=>{
    const e = new Error("Cannot find module '@shadcn/ui/input'");
...
function Products() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            if (editingProduct) {
                await axios.put(`http://localhost:5000/products/${editingProduct._id}`, form);
            } else {
...
//# sourceMappingURL=_cc1b6a._.js.map